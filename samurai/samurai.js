var samuraiLeft = document.getElementById("samurai").style.left = 200 + "px";
...
const samuraiGetLeft = samuraistyle.getPropertyValue("left")

const samuraiWidth = samuraistyle.getPropertyValue("width")
...
function Direita(){
    document.getElementById("samurai").style.left = parseInt(samuraiGetLeft) + 100 + "px"
    console.log("funciona")
    console.log(samuraistyle.getPropertyValue("left"))
}
function Esquerda(){
    document.getElementById("samurai").style.left = parseInt(samuraiGetLeft) - 100 + "px"
    console.log("funciona")
...
function myFunction() {
    ...
    console.log(parseInt(samuraiGetLeft) + 100 + "px")

    setTimeout(() => {
        document.getElementById("myImg").src = "pixil-frame-01.png"
        document.getElementById("samurai").style.left = parseInt(samuraiGetLeft) + 200 + "px"
        console.log(parseInt(samuraiGetLeft) + 200 + "px")
    }, 50)
    ...
    setTimeout(() => {
        ...
        document.getElementById("samurai").style.left = samuraiGetLeft
        document.getElementById("button").style.backgroundColor = "rgb(218, 214, 167)"
    }, 250)
}

function Fdamage() {
    if (parseInt(samuraiGetLeft) + parseInt(samuraiWidth) > damageLeft) {
        console.log("funciona")
